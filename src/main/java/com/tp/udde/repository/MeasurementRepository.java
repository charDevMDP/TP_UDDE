...
public interface MeasurementRepository extends JpaRepository<Measurement, Integer> {
    ...
    Page<Measurement> getMeasurementForDate(Pageable pageable, Integer idMeter, LocalDate startDate, LocalDate endDate);
    ...
    Page<Measurement> getMeasurementForDateForAddress(Pageable pageable, Integer idAddress, LocalDate startDate, LocalDate endDate);
    ...
    Page<UserMeasurementConsumption> getUserForDateForConsumption(Pageable pageable, LocalDate startDate, LocalDate endDate);
