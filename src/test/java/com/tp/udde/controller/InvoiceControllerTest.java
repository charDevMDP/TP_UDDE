...
public class InvoiceControllerTest {
    ...
    public void getInvoiceBetweenDateOKTest(){
        ...
        Page<Invoice> response = invoiceController.getInvoiceBetweenDates(pageable,meter.getId(),localDate,localDate);
    ...
    public void getInvoicesOwedOKTest(){
        ...
        Page<Invoice> response = invoiceController.getInvoicesOwed(pageable,1);
    ...
    public void getInvoicesOwedClient(){
        ...
        when(invoiceService.getInvoicesOwedClient(eq(pageable),anyInt())).thenReturn(PageInvoice);

        Page<InvoiceOwedAddressClient> response = invoiceController.getInvoicesOwedClient(pageable,1);
